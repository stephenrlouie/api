...
func (o *DeleteReleaseURL) Build() (*url.URL, error) {
	...
	if releaseID != "" {
		...
		return nil, errors.New("ReleaseID is required on DeleteReleaseURL")
	}
...
func (o *DeleteReleaseURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteReleaseURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteReleaseURL")
	}
