...
func (o *UpdateReleaseURL) Build() (*url.URL, error) {
	...
	if releaseID != "" {
		...
		return nil, errors.New("ReleaseID is required on UpdateReleaseURL")
	}
...
func (o *UpdateReleaseURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateReleaseURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateReleaseURL")
	}
