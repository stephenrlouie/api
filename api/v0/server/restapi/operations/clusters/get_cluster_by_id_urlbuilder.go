...
func (o *GetClusterByIDURL) Build() (*url.URL, error) {
	...
	if clusterID != "" {
		...
		return nil, errors.New("ClusterID is required on GetClusterByIDURL")
	}
...
func (o *GetClusterByIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetClusterByIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetClusterByIDURL")
	}
