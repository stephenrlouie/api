...
func (m *IoK8sApimachineryPkgApisMetaV1ObjectMeta) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateFinalizers(formats); err != nil {
		// prop
		res = append(res, err)
	}
...
func (m *IoK8sApimachineryPkgApisMetaV1ObjectMeta) validateFinalizers(formats strfmt.Registry) error {

	if swag.IsZero(m.Finalizers) { // not required
		return nil
	}
...
func (m *IoK8sApimachineryPkgApisMetaV1ObjectMeta) validateInitializers(formats strfmt.Registry) error {
